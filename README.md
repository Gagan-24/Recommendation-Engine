...
This is a movie recommendation engine project developed by [Gagan R](https://github.com/Gagan-24).
...
1. Clone the repository:
   ...
   ```bash
   git clone https://github.com/Gagan-24/Recommendation-Engine.git
   ```
